...
<aside id="sidebar-wrapper">
  <div class="sidebar-brand">
    <img src="{{url('frontend/assets/images/logo1.png')}}" alt="logo" width="150">
  </div>
  ...
  <ul class="sidebar-menu">
    ...
    <li class="{{ Request::is('/about') ? 'active' : '' }}">
        <a class="nav-link" href="{{ url('/about') }}"><i class="fas fa-users"></i> <span>Tentang Kami</span></a>
    </li>

    <li class="menu-header">Publikasi 1</li>
    <li class="nav-item dropdown">
        <a href="#"
        class="nav-link has-dropdown"
        data-toggle="dropdown"><i class="fas fa-columns"></i> <span>Berita</span></a>
        <ul class="dropdown-menu">
            <li class="{{ Request::is('dashboard/artikel') ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('dashboard/artikel') }}">Artikel</a>
            </li>
    ...
    <li class="nav-item dropdown">
        <a href="#"
        class="nav-link has-dropdown"
        data-toggle="dropdown"><i class="fas fa-columns"></i> <span>Kerja Sama</span></a>
        <ul class="dropdown-menu">
            <li>
    ...
    <li class="menu-header">Publikasi 3</li>
    <li class="{{ Request::is('/loker') ? 'active' : '' }}">
        <a class="nav-link" href="{{ url('/loker') }}"><i class="fas fa-columns"></i> <span>Lowongan kerja</span></a>
    </li>
    {{-- <li class="nav-item dropdown">
        <a href="#"
        class="nav-link has-dropdown"
        ...
        <ul class="dropdown-menu">
            <li class="{{ Request::is('/loker') ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('/loker') }}">Lowongan Kerja</a>
            </li> --}}
    ...
    <li class="nav-item dropdown">
        <a href="#"
        class="nav-link has-dropdown"
        data-toggle="dropdown"><i class="fas fa-columns"></i> <span>Tracer Study</span></a>
        <ul class="dropdown-menu">
            <li class="{{ Request::is('/question') ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('/question') }}">Pertanyaan</a>
            </li>
            <li class="{{ Request::is('/hasil') ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('/hasil') }}">Jawaban</a>
            </li>
            <li class="{{ Request::is('/bobot_nilai') ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('/bobot_nilai') }}">Penilaian</a>
            </li>
            <li class="{{ Request::is('/tahun') ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('/tahun') }}">Tahun Akademik</a>
            </li>
            <li class="{{ Request::is('/semester') ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('/semester') }}">Data Semester</a>
            </li>
