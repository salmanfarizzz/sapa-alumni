...
<aside id="sidebar-wrapper">
  ...
  <ul class="sidebar-menu">
    ...
    <li class="menu-header">Kuisioner</li>
    <li class="nav-item dropdown">
        <a href="#"
        class="nav-link has-dropdown"
        data-toggle="dropdown"><i class="fas fa-columns"></i> <span>Tracer Study</span></a>
        <ul class="dropdown-menu">
            <li class="{{ Request::is('/tracer/create') ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('/tracer/create') }}">Tracer</a>
            </li>
        </ul>
    </li>
    ...
    <hr>
    <li><a class="nav-link" href="/dashboard/logout"><i class="fas fa-sign-out-alt"></i> <span>Keluar</span></a></li>
  </ul>
</aside>
</div>
