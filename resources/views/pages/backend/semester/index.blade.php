    ...
    <section class="section">
        ...
        <div class="card">
            <div class="card-header">
                <a href="semester/create" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Data Semester</a>
            </div>
            <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    <a href="{{ route('semester.edit', $dt->id) }}" class="btn btn-icon btn-primary">
                                        <i class="fas fa-edit"></i></a>
                                    <form action="{{ route('semester.destroy', $dt->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    @foreach ($data as $dt)
                    <form id="formDelete" action="{{ route('semester.destroy', ['id' => $dt->id]) }}" method="post">
                    @endforeach
                    @csrf
                    @method('DELETE')
