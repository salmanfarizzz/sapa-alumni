 ...
 <div class="section-header">
  ...
  <div class="card">
    <div class="card-header">
        <a href="{{ route('jawaban_pertanyaan.create', $question->id) }}" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Data</a>
    </div>
    <div class="card-body">
              ...
              <tr>
                ...
                <td>
                  <div class="btn-group btn-group-sm">
                    <a href="{{ route('jawaban_pertanyaan.edit', $op->id) }}"
                      class="btn btn-square btn-primary m-2"><i class="fa fa-pen"></i></a>
                      <form action="{{ route('jawaban_pertanyaan.destroy', $op->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
                        <button type="submit"
