					...
					<div class="news_posts">
						...
						<div class="news_post">
							<div class="news_post_image">
								...
								@if(isset($a->data_kategori) && count($a->data_kategori) > 0)
							...
							<div class="news_post_top d-flex flex-column flex-sm-row">
								...
								<div class="news_post_title_container">
									<div class="news_post_title">
										<a href="{{ url('/news_post', $a->id) }}">{{ $a->judul }}</a>
									</div>
									<div class="news_post_meta">
										<span class="news_post_author">
											<a href="#" class="meta-item author"><i class="fa fa-user"></i>{{ $a->nama }}</a>
										</span>
										<span>|</span>
					...
					<div class="sidebar">
						...
						<div class="sidebar_section">
							...
							<ul class="sidebar_list">
								@foreach($kategori_menu as $category)
						...
						<div class="sidebar_section">
							...
							<div class="tags d-flex flex-row flex-wrap">
								...
								<div class="tag"><a href="{{ url($km->slug) }}">{{ $km->nama }}</a></div>
								@endforeach
							</div>
						</div>
