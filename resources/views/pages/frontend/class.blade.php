...
<!-- Home -->
	...
	<div class="home">
		...
		<div class="home_content">
			<h1>Career Class & Alumni Sharing</h1>
		</div>
	</div>
					...
					<div class="news_posts">
						...
						<div class="news_post">
							<div class="news_post_image">
								<img src="{{url('frontend/assets/images/seminar.png')}}" alt="https://unsplash.com/@dsmacinnes">
							</div>
							<div class="news_post_top d-flex flex-column flex-sm-row">
								...
								<div class="news_post_title_container">
									<div class="news_post_title">
										<a href="news_post.html">Webinar Karier PT Barata Indonesia (Persero): “How to be Attractive Job Seeker”</a>
									</div>
									<div class="news_post_meta">
										<span class="news_post_author"><a href="#">Oleh : Admin</a></span>
										<span>|</span>
						...
						<div class="news_post">
							<div class="news_post_image">
								<img src="{{url('frontend/assets/images/news_2.jpg')}}" alt="https://unsplash.com/@dsmacinnes">
							</div>
							<div class="news_post_top d-flex flex-column flex-sm-row">
								<div class="news_post_date_container">
									<div class="news_post_date d-flex flex-column align-items-center justify-content-center">
						...
						<div class="news_post">
							<div class="news_post_image">
								<img src="{{url('frontend/assets/images/news_3.jpg')}}" alt="https://unsplash.com/@dsmacinnes">
							</div>
							<div class="news_post_top d-flex flex-column flex-sm-row">
								<div class="news_post_date_container">
									<div class="news_post_date d-flex flex-column align-items-center justify-content-center">
